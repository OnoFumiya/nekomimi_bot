...
{
public:
  using MoveWheelLinear = nekomimi_bot_interfaces::action::MoveWheelLinear;
  using MoveWheelRotate = nekomimi_bot_interfaces::action::MoveWheelRotate;

  using GoalHandleMoveWheelLinear = rclcpp_action::ServerGoalHandle<nekomimi_bot_interfaces::action::MoveWheelLinear>;
  using GoalHandleMoveWheelRotate = rclcpp_action::ServerGoalHandle<nekomimi_bot_interfaces::action::MoveWheelRotate>;
...
RCLCPP_COMPONENTS_REGISTER_NODE(nekomimi_bot::WheelActionServer)