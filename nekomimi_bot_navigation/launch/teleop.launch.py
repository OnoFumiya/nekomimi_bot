...
def generate_launch_description():
    ...
    velocity_topic_name_arg = DeclareLaunchArgument(
        'velocity_topic_name', default_value='/nekomimi_bot/cmd_vel', description='Velocity topic name',
    )
    ...
    max_linear_arg = DeclareLaunchArgument(
        'max_linear', default_value='0.15', description='Maximum linear velocity'
    )
    max_angular_arg = DeclareLaunchArgument(
        'max_angular', default_value='0.35', description='Maximum angular velocity'
    )
    accel_linear_arg = DeclareLaunchArgument(
        'accel_linear', default_value='0.2', description='Linear acceleration'
    )
